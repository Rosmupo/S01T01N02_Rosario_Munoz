/*- Exercici 1
        Crea una classe anomenada "Telèfon" amb els atributs marca i model,
        i el mètode trucar(). Aquest mètode ha de rebre un String amb un número
        de telèfon. El mètode ha de mostrar per consola un missatge dient que
        s’està trucant al número rebut per paràmetre.
        ...
        Des del main() de l’aplicació, crea un objecte Smartphone i crida als
...
public class App {
	...
	SmartPhone smartPhone = new SmartPhone("iphone", "11");

    smartPhone.makeACall("611.111.111");
